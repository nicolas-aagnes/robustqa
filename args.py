...
def get_train_test_args(args=None):
    ...
    parser.add_argument(
        "--train-datasets", type=str, default="squad,nat_questions,newsqa"
    )
    ...
    parser.add_argument(
        "--eval-datasets", type=str, default="race,relation_extraction,duorc"
    )
    ...
    args = parser.parse_args() if args is None else parser.parse_args(args=args)
    return args
